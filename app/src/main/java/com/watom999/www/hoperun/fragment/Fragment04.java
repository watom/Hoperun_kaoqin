...
public class Fragment04 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment04_layout, container, false);
        activity = getActivity();
        findView(view);
        new WebViewTool(activity).initWebView(webview, "http://ehr.hoperun.com:8018/HRIS/Portal/Home.do#nv_1");
        return view;
    }
